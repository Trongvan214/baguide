            ...
            <Grid>
                <Row className="vcenter">
                    ...
                    <div className="stats-type">
                            <p><span className="red">Main Stats: </span>stats that increases every upgrade</p>
                            <p><span className="yellow">Bonus Stats: </span>stats that are obtain or improved every +3 uprgrade</p>
                        </div>
                    </Col>
                </Row>
                <h1 className="bold">There are 2 forms of value:</h1>
                <Row>  
                    <Col md={6}>
                        <Media>
                            <Media.Left>
